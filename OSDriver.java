...
public class OSDriver{
  ...
  //  while(numFiles != 0){
    ...
    //while(index < numProcesses){
      ...
      Process process = new Process(state, minMemory, runtime, name, instructions);
      runtime = 0;
...
//}
    //while(!processes.isEmpty()){
      ...
      //System.out.println("Number of processes: " + processes.size());
      getDispatcher(processes, instructionIndex);
  //  }
...
return myFile;
  ...
  public static void getDispatcher(ArrayList<Process> processes, int index){
    int position = 0;
...
*/
    Dispatcher.dispatch(processes, position, index);
  }
}
